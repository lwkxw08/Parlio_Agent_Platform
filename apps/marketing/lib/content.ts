...
export const PILLARS: Feature[] = [
  {
    ...
    body: "A British-voice AI receptionist that greets callers by your business name, understands what they need and gets it done — 24/7, no hold music, no menus.",
  ...
  },
  {
    ...
    body: "Add your engineers or staff as bookable resources with skills, areas and shifts. Callers are offered any free slot across the team and the job is assigned automatically.",
    points: ["Pooled availability across every engineer", "Least-loaded, round-robin, nearest or preferred assignment", "Day/week Schedule board with a lane per engineer"],
    tag: "Unique",
  },
  {
    icon: "🔧",
  ...
  },
  {
    ...
    points: ["Departments with descriptions that steer routing", "Urgent-keyword escalation to the on-call engineer", "Record the human leg too, with human talk-time analytics"],
  },
  {
    icon: "🎫",
  ...
  {
    icon: "📈",
    title: "Analytics that speak plain English",
    body: "Ask questions in natural language — “how many missed calls after 5pm last month?” — and get charts. Then let the AI Advisor tell you what to change.",
    points: ["Demand, staffing, resolution, revenue and CX insights", "Missed-revenue and lead-value attribution", "Weekly owner digest by email or WhatsApp"],
  },
  {
    icon: "🔍",
    title: "Search every conversation",
    body: "Full-text search across transcripts and summaries, jumping straight to the moment in the recording. QA scores every call and proposes fixes to your FAQs.",
    points: ["Regression pack gates every Studio publish", "Simulation sandbox: test callers vs draft config", "Auto-improve loop proposes only real improvements"],
  },
  {
    icon: "🏢",
...
export const COMPARE: CompareRow[] = [
  ...
  { label: "Pooled availability across a team of engineers + auto-assignment", us: "yes", answering: "no", ivr: "no", chatbot: "no", booking: "part" },
  { label: "Books into your scheduling tool (ServiceM8, webhook)", us: "yes", answering: "no", ivr: "no", chatbot: "no", booking: "no" },
  { label: "Day/week schedule board with a lane per engineer", us: "yes", answering: "no", ivr: "no", chatbot: "no", booking: "part" },
  { label: "Warm transfer with a spoken briefing to your staff", us: "yes", answering: "part", ivr: "Cold only", chatbot: "no", booking: "no" },
  { label: "Emergency handling: on-call engineer or out-of-hours booking", us: "yes", answering: "part", ivr: "no", chatbot: "no", booking: "no" },
  ...
  { label: "Natural-language analytics + AI business advisor", us: "yes", answering: "no", ivr: "no", chatbot: "no", booking: "no" },
...
export const INDUSTRIES = [
  { id: "trades", title: "Plumbers, heating & electrical", body: "Book the boiler service at 90 minutes and the repair at 60, keep 30 minutes travel between jobs, and send genuine emergencies to the on-call engineer.", pains: ["Missed calls while on the tools", "Double-booked vans", "Out-of-hours emergencies"] },
...
export const STEPS = [
  ...
  { title: "Connect your diary and team", body: "Link Google or Outlook, set booking rules and service types, add engineers with their skills and shifts — or point it at your scheduling tool." },
