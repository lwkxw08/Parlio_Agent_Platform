...
export const metadata: Metadata = {
  title: "Why ParlioTec",
  description: "How ParlioTec compares with answering services, IVR phone systems, chatbot-only AI receptionists and booking-link tools.",
};
...
const DIFFS = [
  ...
  { t: "A real team, not one diary", b: "Engineers with skills, areas, shifts and their own calendar. Pooled availability means the caller hears the earliest slot anyone suitable has; assignment is least-loaded, round-robin, nearest or preferred. The Schedule board shows every lane." },
  ...
  { t: "Calendar events an engineer can act on", b: "Title “Service – Name”, phone, address (as the location), what the caller described, caller ID and a link straight to the recording and transcript." },
  ...
  { t: "Booking-first when it sounds urgent", b: "“No hot water” is an appointment, not an emergency. Unless the tenant marks it so, the assistant offers the earliest slot — and asks before sending anyone to the on-call engineer." },
  ...
  return (
    <>
      <PageHero
        ...
        title="Built to do the things other “AI receptionists” hand back to you"
