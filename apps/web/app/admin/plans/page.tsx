import { fetchAdminCoupons, fetchAdminPlanDefaults, fetchAdminPlans, fetchBillingSettings, fetchEntitlementCatalogue, fetchMe } from "@/lib/api";
...
export default async function Page() {
  const [me, plans, coupons, catalogue, defaults, billing] = await Promise.all([fetchMe(), fetchAdminPlans(), fetchAdminCoupons(), fetchEntitlementCatalogue(), fetchAdminPlanDefaults(), fetchBillingSettings()]);
