...
const I = {
  ...
  schedule: <svg viewBox="0 0 24 24" {...S}><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M3 10h18M8 3v4M16 3v4M7 14h4M7 18h7" /></svg>,
...
export const GROUPS: Group[] = [
  {
    ...
    items: [
      ...
      { href: "/schedule", label: "Schedule", icon: I.schedule },
