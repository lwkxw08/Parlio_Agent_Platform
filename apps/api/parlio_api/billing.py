...
PLANS: list[Plan] = [
    Plan(
        ...
        features=[
            "1 assistant, 1 number",
            "Calendar booking",
            "Tickets & callbacks",
            "SMS follow-ups & alerts",
    ...
    Plan(
        ...
        max_members=10,
        features=[
            "3 assistants, 3 numbers, 10 dashboard users",
            "Warm transfers & departments",
            "Team scheduling (5 team members, 3 locations)",
            "AI call-backs",
            "WhatsApp, CRM & Zapier connectors",
            "Live listen / take over, Ask AI, AI advisor",
        ],
    ...
    Plan(
        ...
        max_members=15,
        features=[
            "10 assistants, 10 numbers",
            "25 team members, 10 locations",
            "BYO SIP / PBX",
            "Scheduling-tool integration & payment links",
            "White-label, simulation sandbox & A/B",
            "Priority support (P1 24x7)",
        ],
