...
**21b Analytics UI (0.75)** — new "Insights" section (Demand, Trends, Resolution, Team, Customers, Revenue tabs) using the shared breakdown/heat-map components, period + compare pickers, "Ask AI" wired to the new measures, CSV export, scheduled report emails.
